...
> Executado em: **2026-05-31** (via SSH em `ovh-spark`, Ubuntu 25.04)
...
| Atributo | Valor |
|----------|-------|
| Servidor | `ovh-spark` (54.36.100.35:49222) |
...
- IP e portas de origem/destino (`from=130.41.103.49 35675 54.36.100.35 49222`)
...
**Exemplo de linha:**
```
2026-05-31T18:22:51Z user=guardian-poc from=130.41.103.49 35675 54.36.100.35 49222 \
...
## 8. Cleanup executado em ovh-spark
