...
const TRUSTED_FINGERPRINTS = new Set([
  'SHA256:le97Bh0M5P9+YM64bwSNc6/CPDB/9TJ30vdDp5p4yLc',
  'SHA256:Qinsq9Y8IrkOX7dBcOZq3NDXcUj9UchKaC+ZHipItHE',
  'SHA256:zXj4Frs7mMeGd+qINrFK6RSuqQvGwzhm+qHFsOhsYEM',
]);
